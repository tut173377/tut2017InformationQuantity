...
//    }
    ...
    double [] EstimationPartition = new double[myTarget.length+1];
    EstimationPartition[0] = (double) 0.0;
    for(int n=1;n<=myTarget.length;n++) {
        ...
        for(int start=n-1;start>=0;start--) {
            ...
            if(freq != 0) {
                ...
                double value1 = EstimationPartition[start]+iq(freq);
        ...
        EstimationPartition[n]=value;
    }
        return EstimationPartition[myTarget.length];
    }
